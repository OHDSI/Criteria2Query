	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h3>Parse Result</h3>
				<h6>instructions....</h6>
				<form id="formSearch" action="<%=basePath%>ohdsi/conceptresult" class="form-horizontal">
					...
					<textarea class="form-control" rows="10" readonly="true"><root>
	&lt;sent>
		...
		&lt;entity class="Condition" index="T1" negated="N" relation="None" start="5"> HIV &lt;/entity&gt;
		&lt;attribute class="Qualifier" index="T2" start="7"> multiple &lt;/attribute&gt;
		&lt;attribute class="Qualifier" index="T3" start="9"> severe &lt;/attribute&gt;
		&lt;entity class="Condition" index="T4" negated="N" relation="T2:modified_by|T3:modified_by" start="10"> drug allergies &lt;/entity&gt;
