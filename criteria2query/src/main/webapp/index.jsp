...
<div class="container projects">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            <p class="masthead-button-links">
                <a class="btn btn-success" id="auto" style="display:none" role="button">&nbsp;&nbsp;Identify Patients in
                    ATLAS&nbsp;&nbsp;</a>
                <a class="btn btn-primary" id="downloadfile" style="display:none" role="button">&nbsp;&nbsp;Download
                    Criteria JSON File&nbsp;&nbsp;</a>
