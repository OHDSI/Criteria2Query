...
public class ConceptFilteringServiceImpl implements IConceptFilteringService {
    ...
    public Document removeRedundency(Document doc) {
        ...
        if (doc.getInitial_event() != null) {
            ...
            originalp = filterOutTerms(originalp, termpool);//Remove the redundant terms in the initial event.
            termpool = updateTermSet(originalp, termpool);//Add terms in the document to the termpool.
        ...
        if (doc.getInclusion_criteria() != null) {
            ...
            originalp = filterOutTerms(originalp, termpool);//Remove the redundant terms in the inclusion criteria.
        ...
        if (doc.getExclusion_criteria() != null) {
            ...
            originalp = filterOutTerms(originalp, termpool);//Remove the redundant terms in the exclusion criteria.
            doc.setExclusion_criteria(originalp);
        }
        return doc;
    }

    // Remove the redundant terms in the document.
