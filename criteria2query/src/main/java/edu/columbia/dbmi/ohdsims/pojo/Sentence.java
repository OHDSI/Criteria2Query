...
public class Sentence implements Cloneable {
    ...
    private List<Integer> negateCues;
    private List<Term> primaryEntities; //First types of entities
    private List<Term> attributes; //Second types of entities
    ...
    public List<Term> getAll_terms() {
        return all_terms;
    }

    public void setAll_terms(List<Term> all_terms) {
        this.all_terms = all_terms;
    }
...
//	}
    ...
    public List<Integer> getNegateCues() {
        return negateCues;
    }

    public void setNegateCues(List<Integer> negateCues) {
        this.negateCues = negateCues;
    }

    public List<Term> getPrimaryEntities() {
        return primaryEntities;
    }

    public void setPrimaryEntities(List<Term> primaryEntities) {
